                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="profile-img-edit position-relative">
                                <img src="{{ asset('storage/' . $package->package_image) }}" alt="Package-Image" class="profile-pic rounded avatar-100">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('name', old('name', $package->name), ['class' => 'form-control', 'id' => 'name', 'placeholder' => 'Enter Package Name', 'required']) }}
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="description">Description:</label>
                            {{ Form::textarea('description', old('description', $package->description), ['class' => 'form-control', 'id' => 'description', 'placeholder' => 'Enter Description']) }}
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="price">Price:</label>
                            {{ Form::number('price', old('price', $package->price), ['class' => 'form-control', 'id' => 'price', 'placeholder' => 'Enter Price', 'step' => 'any']) }}
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="duration">Duration:</label>
                            {{ Form::text('duration', old('duration', $package->duration), ['class' => 'form-control', 'id' => 'duration', 'placeholder' => 'Enter Duration']) }}
                        </div>
                        <div class="form-group">
                            <label class="form-label">Status:</label>
                            <div class="grid" style="--bs-gap: 1rem">
                                <div class="form-check g-col-6">
                                    {{ Form::radio('status', 'active', old('status', $package->status) === 'active', ['class' => 'form-check-input', 'id' => 'status-active']) }}
                                    <label class="form-check-label" for="status-active">Active</label>
                                </div>
                                <div class="form-check g-col-6">
                                    {{ Form::radio('status', 'inactive', old('status', $package->status) === 'inactive', ['class' => 'form-check-input', 'id' => 'status-inactive']) }}
                        ...
                        <button type="submit" class="btn btn-primary mt-4">Update Package</button>
                    </div>
                </div>
            </div>
        </div>
