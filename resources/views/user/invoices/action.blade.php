<div class="flex align-items-center list-user-action">
    <!-- View Package Button -->
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="View Package" href="{{ route('packages.show', $id) }}">
    ...
    @else
        <!-- Optional actions for non-admin users -->
        <!-- You can add actions specific to users here, if needed -->
    @endif
</div>
