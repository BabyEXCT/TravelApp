...
@include('user.dashboard._body_sidebar')
<main class="main-content">
    <div class="position-relative">
    @include('user.dashboard._body_header')
    @include('user.dashboard.sub-header')
    </div>
...
@include('user.components.setting-offcanvas')
@include('user.dashboard._scripts')
@include('user.dashboard._app_toast')
